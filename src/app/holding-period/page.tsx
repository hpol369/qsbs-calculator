...
export const metadata: Metadata = {
  title: "QSBS Holding Period Rules | The 5-Year Clock Explained",
  description: "Deep dive into the 5-year QSBS holding period. When does it start? How do ISO exercises, 83(b) elections, and convertible notes affect your timeline?",
  alternates: {
