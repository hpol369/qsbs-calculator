...
export const metadata: Metadata = {
  title: "QSBS California Tax Treatment | Does CA Conform to 1202?",
  description: "California does NOT conform to Federal Section 1202 QSBS rules. Calculate your state tax liability and learn about the 13.3% clawback.",
  alternates: {
